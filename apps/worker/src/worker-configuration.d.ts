/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/worker/src/worker-configuration.d.ts` (hash: a56016a7f29eda512318d15b8c10b893)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	MATCHMAKER: DurableObjectNamespace<import("./index").Matchmaker>;
	GAME_ROOMS: DurableObjectNamespace<import("./index").GameRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Matchmaker" | "GameRoom";
	}
